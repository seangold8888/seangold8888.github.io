...
- 원화 교체 작업에서는 카드 수치·기술·퀴즈·소리를 변경하지 않았고 Codex가 직접 push하지 않았다. 이후 H2 푸시에 원화 커밋 `79e7429`가 포함되어 현재 공개 사이트에 반영되어 있다(검수자 2026-09-13 19:07 보고, GitHub Pages built 확인).
