...
test("cache generation v121 preserves exact v63 card assets and canonical navigation aliases", () => {
  assert.equal(sw.CACHE_VERSION, "v121");
  assert.match(sw.STATIC_CACHE, /^adventure-box-v121-/);
