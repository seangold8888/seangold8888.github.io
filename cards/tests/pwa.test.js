...
test("cache generation v55 preserves exact v27 card assets and canonical navigation aliases", () => {
  assert.equal(sw.CACHE_VERSION, "v55");
  assert.match(sw.STATIC_CACHE, /^adventure-box-v55-/);
