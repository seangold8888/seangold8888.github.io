...
test("cache generation v52 preserves exact v26 card assets and canonical navigation aliases", () => {
  assert.equal(sw.CACHE_VERSION, "v52");
  assert.match(sw.STATIC_CACHE, /^adventure-box-v52-/);
