...
test("cache generation v96 preserves exact v55 card assets and canonical navigation aliases", () => {
  assert.equal(sw.CACHE_VERSION, "v96");
  assert.match(sw.STATIC_CACHE, /^adventure-box-v96-/);
  ...
  for (const asset of ["styles.css", "campaign.css", "engine.js", "audio.js", "card-view.js", "vfx-recipes.js", "story-gates.js", "campaign.js", "campaign-ui.js", "combat-cinema.js", "app.js"]) {
    assert.ok(sw.CORE_SHELL.some(entry => entry.endsWith(asset + "?v=55")), asset);
  }
