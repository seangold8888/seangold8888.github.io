...
test("cache generation v44 preserves exact v26 card assets and canonical navigation aliases", () => {
  assert.equal(sw.CACHE_VERSION, "v44");
  assert.match(sw.STATIC_CACHE, /^adventure-box-v44-/);
