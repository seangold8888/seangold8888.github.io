...
test("cache generation v110 preserves exact v63 card assets and canonical navigation aliases", () => {
  assert.equal(sw.CACHE_VERSION, "v110");
  assert.match(sw.STATIC_CACHE, /^adventure-box-v110-/);
  ...
  assert.ok(sw.OPTIONAL_SHELL.includes("./princess/studio.js?v=39"));
