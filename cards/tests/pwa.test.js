...
test("cache generation v86 preserves exact v45 card assets and canonical navigation aliases", () => {
  assert.equal(sw.CACHE_VERSION, "v86");
  assert.match(sw.STATIC_CACHE, /^adventure-box-v86-/);
  ...
  for (const asset of ["styles.css", "campaign.css", "engine.js", "audio.js", "card-view.js", "vfx-recipes.js", "story-gates.js", "campaign.js", "campaign-ui.js", "combat-cinema.js", "app.js"]) {
    assert.ok(sw.CORE_SHELL.some(entry => entry.endsWith(asset + "?v=45")), asset);
  }
