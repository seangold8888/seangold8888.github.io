...
test("cache generation v83 preserves exact v42 card assets and canonical navigation aliases", () => {
  assert.equal(sw.CACHE_VERSION, "v83");
  assert.match(sw.STATIC_CACHE, /^adventure-box-v83-/);
