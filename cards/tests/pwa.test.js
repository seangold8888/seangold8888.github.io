...
test("cache generation v41 preserves exact v26 card assets and canonical navigation aliases", () => {
  assert.equal(sw.CACHE_VERSION, "v41");
  assert.match(sw.STATIC_CACHE, /^adventure-box-v41-/);
