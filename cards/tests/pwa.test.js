...
test("cache generation v43 preserves exact v26 card assets and canonical navigation aliases", () => {
  assert.equal(sw.CACHE_VERSION, "v43");
  assert.match(sw.STATIC_CACHE, /^adventure-box-v43-/);
