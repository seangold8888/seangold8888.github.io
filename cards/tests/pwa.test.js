...
test("cache generation v40 preserves exact v26 card assets and canonical navigation aliases", () => {
  assert.equal(sw.CACHE_VERSION, "v40");
  assert.match(sw.STATIC_CACHE, /^adventure-box-v40-/);
