...
test("cache generation v54 preserves exact v27 card assets and canonical navigation aliases", () => {
  assert.equal(sw.CACHE_VERSION, "v54");
  assert.match(sw.STATIC_CACHE, /^adventure-box-v54-/);
