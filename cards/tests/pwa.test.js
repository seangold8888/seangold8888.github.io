...
test("cache generation v58 preserves exact v27 card assets and canonical navigation aliases", () => {
  assert.equal(sw.CACHE_VERSION, "v58");
  assert.match(sw.STATIC_CACHE, /^adventure-box-v58-/);
