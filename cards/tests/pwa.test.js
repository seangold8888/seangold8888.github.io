...
test("cache generation v34 preserves exact v26 card assets and canonical navigation aliases", () => {
  assert.equal(sw.CACHE_VERSION, "v34");
  assert.match(sw.STATIC_CACHE, /^adventure-box-v34-/);
  ...
  assert.ok(sw.OPTIONAL_SHELL.includes("./princess/studio.js?v=34"));
