...
test("cache generation v118 preserves exact v63 card assets and canonical navigation aliases", () => {
  assert.equal(sw.CACHE_VERSION, "v118");
  assert.match(sw.STATIC_CACHE, /^adventure-box-v118-/);
  ...
  assert.ok(sw.OPTIONAL_SHELL.includes("./princess/studio.js?v=47"));
