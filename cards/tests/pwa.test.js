...
test("cache generation v111 preserves exact v63 card assets and canonical navigation aliases", () => {
  assert.equal(sw.CACHE_VERSION, "v111");
  assert.match(sw.STATIC_CACHE, /^adventure-box-v111-/);
