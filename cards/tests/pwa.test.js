...
test("cache generation v37 preserves exact v26 card assets and canonical navigation aliases", () => {
  assert.equal(sw.CACHE_VERSION, "v37");
  assert.match(sw.STATIC_CACHE, /^adventure-box-v37-/);
