...
test("cache generation v142 preserves exact v65 card assets and canonical navigation aliases", () => {
  assert.equal(sw.CACHE_VERSION, "v142");
  assert.match(sw.STATIC_CACHE, /^adventure-box-v142-/);
  ...
  for (const asset of ["styles.css", "campaign.css", "engine.js", "audio.js", "card-view.js", "vfx-recipes.js", "story-gates.js", "campaign.js", "campaign-ui.js", "combat-cinema.js", "app.js"]) {
    assert.ok(sw.CORE_SHELL.some(entry => entry.endsWith(asset + "?v=65")), asset);
  }
