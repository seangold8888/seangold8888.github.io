...
test("cache generation v42 preserves exact v26 card assets and canonical navigation aliases", () => {
  assert.equal(sw.CACHE_VERSION, "v42");
  assert.match(sw.STATIC_CACHE, /^adventure-box-v42-/);
