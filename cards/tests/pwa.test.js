...
test("cache generation v101 preserves exact v60 card assets and canonical navigation aliases", () => {
  assert.equal(sw.CACHE_VERSION, "v104");
  assert.match(sw.STATIC_CACHE, /^adventure-box-v104-/);
  ...
  for (const asset of ["styles.css", "campaign.css", "engine.js", "audio.js", "card-view.js", "vfx-recipes.js", "story-gates.js", "campaign.js", "campaign-ui.js", "combat-cinema.js", "app.js"]) {
    assert.ok(sw.CORE_SHELL.some(entry => entry.endsWith(asset + "?v=60")), asset);
  }
