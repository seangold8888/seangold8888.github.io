...
test("cache generation v117 preserves exact v63 card assets and canonical navigation aliases", () => {
  assert.equal(sw.CACHE_VERSION, "v117");
  assert.match(sw.STATIC_CACHE, /^adventure-box-v117-/);
  ...
  assert.ok(sw.OPTIONAL_SHELL.includes("./princess/studio.js?v=46"));
