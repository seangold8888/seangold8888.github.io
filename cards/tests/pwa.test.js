...
test("cache generation v100 preserves exact v59 card assets and canonical navigation aliases", () => {
  assert.equal(sw.CACHE_VERSION, "v100");
  assert.match(sw.STATIC_CACHE, /^adventure-box-v100-/);
  ...
  for (const asset of ["styles.css", "campaign.css", "engine.js", "audio.js", "card-view.js", "vfx-recipes.js", "story-gates.js", "campaign.js", "campaign-ui.js", "combat-cinema.js", "app.js"]) {
    assert.ok(sw.CORE_SHELL.some(entry => entry.endsWith(asset + "?v=59")), asset);
  }
