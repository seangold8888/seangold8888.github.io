...
test("cache generation v61 preserves exact v29 card assets and canonical navigation aliases", () => {
  assert.equal(sw.CACHE_VERSION, "v61");
  assert.match(sw.STATIC_CACHE, /^adventure-box-v61-/);
