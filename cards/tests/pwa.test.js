...
test("cache generation v51 preserves exact v26 card assets and canonical navigation aliases", () => {
  assert.equal(sw.CACHE_VERSION, "v51");
  assert.match(sw.STATIC_CACHE, /^adventure-box-v51-/);
