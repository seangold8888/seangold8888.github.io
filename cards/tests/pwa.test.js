...
test("cache generation v108 preserves exact v63 card assets and canonical navigation aliases", () => {
  assert.equal(sw.CACHE_VERSION, "v108");
  assert.match(sw.STATIC_CACHE, /^adventure-box-v108-/);
