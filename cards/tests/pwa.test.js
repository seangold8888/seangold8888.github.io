...
test("cache generation v70 preserves exact v36 card assets and canonical navigation aliases", () => {
  assert.equal(sw.CACHE_VERSION, "v70");
  assert.match(sw.STATIC_CACHE, /^adventure-box-v70-/);
  ...
  for (const asset of ["styles.css", "engine.js", "audio.js", "card-view.js", "vfx-recipes.js", "story-gates.js", "app.js"]) {
    assert.ok(sw.CORE_SHELL.some(entry => entry.endsWith(asset + "?v=36")), asset);
  }
