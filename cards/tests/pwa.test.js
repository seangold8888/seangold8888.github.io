...
test("cache generation v109 preserves exact v63 card assets and canonical navigation aliases", () => {
  assert.equal(sw.CACHE_VERSION, "v109");
  assert.match(sw.STATIC_CACHE, /^adventure-box-v109-/);
