...
const campaignIds = ["sseugumi", "sejong", "jangyeongsil", "heojun", "shinsaimdang", "jeongyakyong", "kimhongdo", "yugwansun", "kimgu", "jaewing", "yunchan", "yungeon", "taeppul", "chanppul", "geonppul"];
...
test("G3 and G4 keep their first 40 cards byte-stable and balanced after the East expansion", () => {
  assert.equal(data.cards.length, 90);
