...
test("cache v51 precaches nine praise and 38 word MP3s; hub has no second celebration delay",()=>{
  const sw=require("../../sw.js"),html=fs.readFileSync(path.join(__dirname,"../../index.html"),"utf8");
  assert.equal(sw.CACHE_VERSION,"v51");assert.ok(sw.CORE_SHELL.includes("./assets/study/english-reading.js?v=7"));
