(function () {
  ...
  [
    ...
    question("yunchan-age", "yunchan",
      ...
      ["가족 확인 2026-09-24"]),
    question("yunchan-hobby", "yunchan",
      "윤찬이가 제일 좋아하는 놀이는?",
      [["bugs", "벌레 채집"], ["soccer", "축구"], ["piano", "피아노"]], "bugs",
      ["가족 확인 2026-09-24"]),
    question("yunchan-light", "yunchan",
      "윤찬이의 「반딧불이 불빛」을 쓰면 무엇을 돌려받나요?",
      [["star", "별사탕 1개"], ["hp", "체력 20"], ["turn", "한 턴 더"]], "star",
      ["카드: 윤찬"]),
    question("yunchan-book", "yunchan",
      "윤찬이의 특성 「곤충 도감」은 무엇을 하나요?",
      [["noweak", "약점 추가 피해를 받지 않아요"], ["heal", "매턴 체력을 채워요"], ["double", "피해가 두 배가 돼요"]], "noweak",
      ["카드: 윤찬"]),
    question("yunchan-big-move", "yunchan",
      "윤찬이가 별사탕 3개로 쓰는 큰 기술은?",
      [["beetle", "장수풍뎅이 돌진"], ["net", "잠자리채 휙"], ["firefly", "반딧불이 불빛"]], "beetle",
      ["카드: 윤찬"]),
    question("yungeon-age", "yungeon",
      "윤건이는 몇 살인가요?",
      [["seven", "일곱 살"], ["ten", "열 살"], ["five", "다섯 살"]], "seven",
      ["가족 확인 2026-09-24"]),
    question("yungeon-sport", "yungeon",
      "윤건 카드에서 윤건이가 하는 운동은?",
      [["soccer", "축구"], ["swim", "수영"], ["bugs", "벌레 채집"]], "soccer",
      ["가족 확인 2026-09-24"]),
    question("yungeon-dribble", "yungeon",
      "윤건이의 「헛다리 드리블」에 속은 상대는 어떻게 되나요?",
      [["weak", "다음 공격 피해가 20 줄어요"], ["sleep", "잠이 들어요"], ["star", "별사탕을 잃어요"]], "weak",
      ["카드: 윤건"]),
    question("yungeon-gloves", "yungeon",
      "윤건이의 특성 「골키퍼 장갑」은 무엇을 막나요?",
      [["first", "처음 받는 공격 한 번"], ["all", "모든 공격"], ["none", "아무것도 못 막아요"]], "first",
      ["카드: 윤건"]),
    question("yungeon-fire-shot", "yungeon",
      "윤건이의 「불꽃 슛」을 맞은 상대는 어떻게 되나요?",
