(function () {
  ...
  const cardStories = Object.freeze({
    ...
    shinsaimdang: "legend:shinsaimdang",
    jeongyakyong: "legend:jeongyakyong",
    kimhongdo: "legend:kimhongdo",
    yugwansun: "legend:yugwansun",
    kimgu: "legend:kimgu",
    sseugumi: "legend:sseugumi",
    heracles: "heracles",
    ...
    appa: "family:appa",
    eomma: "family:eomma",
    yunchan: "family:yunchan",
    yungeon: "family:yungeon",
  ...
  [
    ...
    question("yunchan-age", "yunchan",
      "윤찬이는 몇 살인가요?",
      [["ten", "열 살"], ["seven", "일곱 살"], ["five", "다섯 살"]], "ten",
      ["가족 확인 2026-09-24"]),
    question("yunchan-sport", "yunchan",
      "윤찬 카드에서 윤찬이가 하고 있는 운동은?",
      [["soccer", "축구"], ["swim", "수영"], ["taekwondo", "태권도"]], "soccer",
      ["카드: 윤찬"]),
    question("yunchan-pass", "yunchan",
      "윤찬이의 「헤딩 패스」를 쓰면 무엇을 돌려받나요?",
      [["star", "별사탕 1개"], ["hp", "체력 20"], ["turn", "한 턴 더"]], "star",
      ["카드: 윤찬"]),
    question("yunchan-captain", "yunchan",
      "윤찬이의 특성 「주장 완장」은 무엇을 하나요?",
      [["noweak", "약점 추가 피해를 받지 않아요"], ["heal", "매턴 체력을 채워요"], ["double", "피해가 두 배가 돼요"]], "noweak",
      ["카드: 윤찬"]),
    question("yunchan-big-move", "yunchan",
      "윤찬이가 별사탕 3개로 쓰는 큰 기술은?",
      [["shot", "번개 슛"], ["dribble", "번개 드리블"], ["header", "헤딩 패스"]], "shot",
      ["카드: 윤찬"]),
    question("yungeon-age", "yungeon",
      "윤건이는 몇 살인가요?",
      [["seven", "일곱 살"], ["ten", "열 살"], ["five", "다섯 살"]], "seven",
      ["가족 확인 2026-09-24"]),
    question("yungeon-friend", "yungeon",
      "윤건 카드에서 윤건이가 동굴에서 찾은 친구는?",
      [["dino", "아기 공룡"], ["cat", "아기 고양이"], ["dragon", "용"]], "dino",
      ["카드: 윤건"]),
    question("yungeon-flash", "yungeon",
      "윤건이의 「손전등 번쩍」을 맞으면 상대는 어떻게 되나요?",
      [["weak", "다음 공격 피해가 20 줄어요"], ["sleep", "잠이 들어요"], ["star", "별사탕을 잃어요"]], "weak",
      ["카드: 윤건"]),
    question("yungeon-egg", "yungeon",
      "윤건이의 특성 「공룡 알 방패」는 무엇을 막나요?",
      [["first", "처음 받는 공격 한 번"], ["all", "모든 공격"], ["none", "아무것도 못 막아요"]], "first",
      ["카드: 윤건"]),

    question("yungeon-roar", "yungeon",
      "윤건이의 「티라노 으르렁」을 맞은 상대는 어떻게 되나요?",
      [["skip", "다음 턴에 기술을 못 써요"], ["heal", "체력이 늘어요"], ["fast", "더 빨라져요"]], "skip",
      ["카드: 윤건"]),
  ...
  [
    question("sseugumi-cushion", "sseugumi", "쓰구미가 별사탕 1개로 쓰는 기술은?", [["yes","방귀 쿠션"],["no","대왕 장난"],["other","간지럼 깃털"]], "yes", ["카드: 쓰구미 대마왕"]),
    question("sseugumi-steal", "sseugumi", "사탕 훔치기는 무엇을 가져오나요?", [["yes","상대 별사탕 1개"],["no","상대 카드"],["other","내 체력"]], "yes", ["카드: 쓰구미 대마왕"]),
  ...
  // Biography facts, not fictional battle powers. Source links remain available offline as text.
  const historyProfiles = {
    "sejong": {
      "name": "세종대왕",
      "era": "조선",
      "source": "https://encykorea.aks.ac.kr/Article/E0061508",
      "paragraphs": [
        "세종대왕은 백성이 말을 글로 쉽게 적을 수 있도록 새 글자 훈민정음을 만들었어요. 당시에는 한자를 익히기 어려워 자신의 생각을 글로 전하지 못하는 사람이 많았어요.",
        "새 글자는 1443년에 만들어졌고, 글자의 원리를 설명한 훈민정음 해례본은 1446년에 나왔어요. 오늘 우리가 쓰는 한글의 시작이에요. 글을 더 많은 사람이 읽고 쓸 수 있게 하려는 마음이 담겼지요."
      ],
      "qa": [
        [
          "세종대왕이 만든 새 글자는?",
    ...
    "jangyeongsil": {
      "name": "장영실",
      "era": "조선",
      "source": "https://encykorea.aks.ac.kr/Article/E0048697",
      "paragraphs": [
        "장영실은 조선의 궁궐에서 여러 기구를 만든 기술자예요. 물과 바퀴, 금속을 어떻게 움직여야 하는지 궁리했어요. 세종 때 과학 기구를 만드는 일에 힘을 보탰지요.",
        "1434년에 완성한 자격루는 물을 이용해 시간을 재고 자동으로 시각을 알려 주는 물시계였어요. 혼천의처럼 하늘의 움직임을 살펴보는 기구도 만들었어요. 사람들이 시간과 하늘을 더 잘 알도록 도운 사람이에요."
      ],
      "qa": [
        [
          "장영실은 어떤 일을 했나요?",
    ...
    "heojun": {
      "name": "허준",
      "era": "조선",
      "source": "https://encykorea.aks.ac.kr/Article/E0016731",
      "paragraphs": [
        "허준은 조선의 의사예요. 많은 의학 지식을 모으고 정리해 동의보감이라는 책을 엮었어요. 앞선 의학책들을 살펴보고, 몸과 병을 이해하는 데 도움이 되는 내용을 정돈했지요.",
        "동의보감은 1610년에 완성되고 1613년에 처음 인쇄됐어요. 병이 난 뒤 치료하는 것뿐 아니라 평소 몸을 잘 돌보는 일도 중요하게 여겼어요. 옛 의학을 배우는 자료지만, 오늘 아플 때는 어른과 함께 의사에게 도움을 받아요."
      ],
      "qa": [
        [
          "허준의 직업은?",
    ...
    "shinsaimdang": {
      "name": "신사임당",
      "era": "조선",
      "source": "https://encykorea.aks.ac.kr/Article/E0033037",
      "paragraphs": [
        "신사임당은 조선의 예술가예요. 그림을 그리고 글씨와 시에도 재능을 보였어요. 작은 풀잎과 벌레처럼 가까이에 있는 자연을 눈여겨보는 그림으로 알려져 있어요.",
        "신사임당의 그림으로 전하는 초충도에서 ‘초’는 풀, ‘충’은 벌레를 뜻해요. 풀과 곤충을 살피며 자연의 모습을 배울 수 있지요. 옛 그림 중에는 작가를 확실히 알기 어려운 것도 있어, 모두 직접 그렸다고 단정하지는 않아요."
      ],
      "qa": [
        [
          "신사임당은 어떤 사람으로 소개됐나요?",
    ...
    "jeongyakyong": {
      "name": "정약용",
      "era": "조선",
      "source": "https://contents.history.go.kr/data/pdf/eh/eh_n0610_0010.pdf",
      "paragraphs": [
        "정약용은 조선의 학자예요. 책 속 지식이 실제 사람들의 생활에 어떻게 도움이 될지 생각했어요. 백성의 어려움을 줄이는 일에 관심을 가졌지요.",
        "수원 화성을 짓는 일을 도우며 거중기를 설계했어요. 거중기는 여러 도르래를 이용해 무거운 물건을 들어 올리는 장치예요. 혼자 힘껏 드는 것보다 적은 힘으로 일하도록 궁리한 것이지요. 어려운 일을 만나면 방법을 차근차근 바꿔 생각해 봐요."
      ],
      "qa": [
        [
          "정약용은 어떤 사람이었나요?",
    ...
    "kimhongdo": {
      "name": "김홍도",
      "era": "조선",
      "source": "https://www.museum.go.kr/MUSEUM/contents/M0202010000.do?act=current&exhiSpThemId=3515965&menuId=current&schM=view",
      "paragraphs": [
        "김홍도는 조선의 화가예요. 궁중에서 그림을 그리는 화원으로도 일했어요. 그의 별호는 단원이에요. 사람들의 몸짓과 표정을 잘 살펴 그림에 담았지요.",
        "김홍도의 풍속화에는 서당에서 배우는 아이들과 씨름하는 사람들처럼 일상의 모습이 나와요. 풍속화는 사람들이 살아가는 모습을 그린 그림이에요. 그림을 찬찬히 보면 옛날 사람들의 공부와 놀이를 상상할 수 있어요."
      ],
      "qa": [
        [
          "김홍도의 직업은?",
    ...
    "yugwansun": {
      "name": "유관순",
      "era": "일제강점기",
      "source": "https://encykorea.aks.ac.kr/Article/E0041268",
      "paragraphs": [
        "유관순은 우리나라의 독립을 위해 힘쓴 사람이에요. 학생이던 1919년, 나라의 독립을 바라는 만세 운동에 참여했어요. 어린 나이에도 자신의 뜻을 용기 있게 밝혔지요.",
        "고향인 천안으로 돌아온 뒤에는 사람들과 함께 아우내 장터의 만세 운동을 준비했어요. 1919년 4월 1일 많은 사람이 모여 독립을 외쳤어요. 유관순의 이야기는 혼자가 아니라 이웃과 함께 뜻을 모으는 용기도 알려 줘요."
      ],
      "qa": [
        [
          "유관순이 바랐던 것은?",
    ...
    "kimgu": {
      "name": "김구",
      "era": "일제강점기와 광복 무렵",
      "source": "https://contents.history.go.kr/front/hm/view.do?levelId=hm_126_0055",
      "paragraphs": [
        "김구는 우리나라의 독립을 위해 힘쓴 사람이에요. 대한민국 임시정부에서 활동하며 독립운동을 이어 갔어요. 그의 별호는 백범이에요.",
        "김구는 자신의 삶과 생각을 백범일지에 남겼어요. 자신의 이야기를 기록한 책을 자서전이라고 해요. 지나온 일을 적어 두면 다음 세대가 그 시대의 선택과 마음을 살펴볼 수 있어요. 백범일지를 읽는 것은 옛사람의 목소리에 귀 기울이는 일이에요."
      ],
      "qa": [
        [
          "김구가 힘쓴 일은?",
  ...
  Object.keys(historyProfiles).forEach(cardId => {
    const profile = historyProfiles[cardId];
    profile.qa.forEach(([prompt, answer, wrong1, wrong2], index) => {
      all.push(question(cardId + "-history-" + (index + 1), cardId, prompt,
        [["correct", answer], ["other1", wrong1], ["other2", wrong2]], "correct", [profile.source]));
    });
  });
  deepFreeze(historyProfiles);
