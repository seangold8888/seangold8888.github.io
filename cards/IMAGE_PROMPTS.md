...
- `taeo.png`: 짧은 갈색 머리의 남자아이가 흰 태권도복에 검은띠를 매고 어두운 도장에서 높이 발차기를 한다. 발끝을 따라 붉은 랩터 형상의 궤적.
...
- `jaewing.png`: 재이의 괴물 친구 첫 시안. 폭신한 털과 큰 날개, 장난스럽고 자신감 있는 표정으로 공중을 날아오른다. 밝고 입체적인 채색 동화 카드 원화, 1024×1536, 글자·숫자·카드 테두리 없음. 생성 프롬프트 전문과 사용자 설정/제안의 구분은 DESIGN-JAEWING.md에 기록했다.
