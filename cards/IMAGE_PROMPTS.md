...
- `yunchan.png`: 윤찬(10세) — 짧고 단정한 검은 머리. 검정·하늘색 축구복을 입고 달빛 축구장에서 힘차게 발리슛, 공에 하늘색 번개. 1024×1536, 글자·숫자·로고 없음.
- `yungeon.png`: 윤건(7세) — 동그란 얼굴, 복슬한 갈색 바가지 머리. 노란 탐험복과 주황 배낭, 손전등을 든 채 수정 동굴에서 알을 깨고 나온 아기 공룡을 발견. 1024×1536, 글자·숫자·로고 없음.
