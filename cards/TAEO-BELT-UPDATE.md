...
- 최초 작업 시 서비스 워커 v102, 카드 모듈 v61로 검증했다. 최종 원화 커밋은 `79e7429`이며 서비스 워커 v105 / 카드 모듈 v62로 정리됐다.
- 배포 기록 정정(2026-09-13): 당시 Codex는 로컬 커밋만 했으나, 이후 H2 푸시에 이 커밋이 포함되어 공개 사이트에도 반영됐다. 검수자의 19:07 배포 보고 및 GitHub Pages 빌드 완료 상태를 확인했다. 아래 검수 후속 수정의 배포 여부와 구분한다.
