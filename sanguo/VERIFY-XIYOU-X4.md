...
- 기능 커밋 `466005699ce6e02259ba3d699ec1a4784a146b88`을 `main`에 배포했다.
- GitHub Pages 실행 `34257176124`: `completed / success`.
- 공개 `sw.js`: HTTP 200, cache v63 확인.
- 공개 전장 배경: 24/24 HTTP 200.
- 공개 화과산·사타령을 640×400 터치 Chromium에서 실제 시작했다. 전장마다 배경 요청 3개, 행동 버튼 5개, 왼쪽 스틱 좌표 14~120px, 가로 넘침 없음, 콘솔 오류 0, 실패 응답 0.
- 공개 주소: `https://seangold8888.github.io/sanguo/`.
