...
**X1~X4가 전부 완료됐다.** 8전장·7영웅·전용 보스와 기술, 전장별 3층 그림 배경까지 실제 게임에 연결됐다.
...
| 절차 배경 6종 | 완료 |
| 그림 배경 8전장 × 원경·중경·지면 | X4 완료. 24장, 시차 0.06 / 0.30 / 1.0, 절차 배경 폴백 유지 |
...
추가 X1 원화 통합: 서비스 워커 `v56`, 전장 8개 보존, 나타 건곤권 전용 모션·
차지 투척·승리 교육 문구 연결. 22개 전투 조합 7파도 완주, 신규 원화 5장
투명도·프레임 경계 검사 통과. 상세 재현은 `VERIFY-XIYOU-X1.md`,
제작 기록은 `ART-XIYOU-X1.md`. 실기기 난이도 확인은 아직 남아 있다.
...
제작 프롬프트는 `ART-XIYOU-X3.md`.

추가 X4 통합: 8전장에 원경·투명 중경·지면 원화 24장을 연결했다. 지면 상단 페이드,
0.06/0.30/1.0 패럴랙스, 테마 입자 재사용, 3장 중 하나라도 실패할 때 절차 배경 폴백,
전투 종료 시 이미지 캐시와 합성 버퍼 해제를 구현했다. 공유 캐시 v63, 게임 미디어
207개 등록, 최신 카드 v30을 보존했다. 상세 재현은 `VERIFY-XIYOU-X4.md`,
원본 ID와 전체 제작 프롬프트는 `ART-XIYOU-X4.md`.
...
| X4 | 서유기 8전장 그림 배경 3층 | 완료 — 원화 24장·패럴랙스·폴백·메모리 해제 |
