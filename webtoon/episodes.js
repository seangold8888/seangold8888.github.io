...
(function (root) {
  ...
  const CHARACTERS = [
    ...
    { id: "taeo", name: "태오", tag: "태권도 파란띠 · 누나 괴롭히기 선수", line: "누나 머리끈 뺏기, 흉내 내기… 누나 괴롭히기가 취미인 막내. 사실은 누나가 좋아서 그래요. “맛있는 거 죠!”가 입버릇이고, 어벤져스를 사랑해서 영웅 이름도 태오식으로 불러요(블루베리, 스테잌로저…).", pose: "fist", e: "happy" },
  ];
