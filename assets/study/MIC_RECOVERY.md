...
## 2026-09-19 갤럭시 탭(안드로이드 크롬)

- 안드로이드 크롬은 계속 듣기 모드에서 앞서 들은 말을 다음 결과 조각에 다시 담아 준다고 알려져 있다("I" · "I like" · "I like apples"). 조각을 그대로 이으면 "I I like I like apples"가 되어 맞게 읽어도 틀린다.
- 조치: `collapseRepeats`가 앞 조각을 다시 담은 새 조각이 오면 앞 조각을 버린다. 아이패드·컴퓨터처럼 이어지는 조각("I like" · "apples")은 그대로 잇는다. 모든 기기 공통.
- 삼성 인터넷은 음성 인식이 없을 수 있어, 그 경우 "Chrome으로 열어 주세요"를 띄운다.
- 실제 갤럭시 탭 확인 전이다. `?readinglog=1`로 들린 말을 확인한다.
