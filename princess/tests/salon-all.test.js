...
test('three stable hairstyle IDs preserve old saves, invalid values fall back to base',()=>{
 ...
 const html=fs.readFileSync(path.join(root,'index.html'),'utf8');assert(html.indexOf('salon.js?v=1')<html.indexOf('studio.js?v=47'));assert(html.includes("PrincessSalon?.has(p.id+'-half')"));
});
